...
#Added for updating anchor peers by looping through ORGS list instead of manually calling utils command for each org
updateAnchorPeerForOrgs() {
...
updateAnchorPeerForOrgs #Replaced individual calls to Util.sh updateAnchorPeers with a loop based function
